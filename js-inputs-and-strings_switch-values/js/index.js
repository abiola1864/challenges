...
switchButton.addEventListener("click", () => {
  const currentValue = secondInput.value;
  const newValue = currentValue === currentValue.toUpperCase() ? currentValue.toLowerCase() : currentValue.toUpperCase();
...
//     firstInput.value = temp.toUpperCase();
//   } else {
//     const temp = firstInput.value;
//     firstInput.value = temp.toLowerCase();
//   }
// });