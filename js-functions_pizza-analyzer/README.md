...
function calculatePizzaGain(diameter1, diameter2) {
   var pizzaInput = document.querySelector('[data-js="pizza-input-1"]');
   var pizzaValue = pizzaInput.value;
   var diameter1 = document.querySelector('[data-js="pizza-input-2"]');
   var diameter2 = pizzaInput2.value;
   AreaPizza = 
