...
const weightOfAllAnimalsInAfrica = animals.filter((animal) => animal.continents.includes("Africa"))
...
weightOfAllAnimalsInAfrica / animals.filter((animal) => animal.continents.includes("Africa")).length;
